<x-app-layout>
    ...
    <footer class="fixed bottom-0 left-0 z-20 w-full bg-white border-t border-gray-300 shadow-inner dark:bg-gray-800 dark:border-gray-600">
