<x-app-layout>
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        ...
                        <form method="post" action="{{ route('tipoactuacion.update', $tipoActuacion->id) }}"
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200 w-full">
                                                <tr class="border-b">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 bg-white divide-y divide-gray-200">
                                                        <input type="text" name="name" value="{{ $tipoActuacion->nombre }}"
    ...
    <div class="block text-center">
        <a href="{{ route('tipoactuacion.index') }}"
            class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded"> {{ __('Tornar al llistat') }}
        </a>
    </div>
</x-app-layout>