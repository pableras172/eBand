            ...
            <li class="py-3 sm:py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <a href="{{ route('actuaciones.usuario.listatipo', ['user' => Auth::user()->id, 'year' => $year, 'type' => $tipoActuacion['tipoactuacion_id']]) }}" class="text-sm font-medium text-gray-900 truncate dark:text-white">
                            {{ $tipoActuacionNombre }} 
                        </a>                                               
                    </div>
