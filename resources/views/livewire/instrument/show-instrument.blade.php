                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <div class="block text-right mb-6">
                                <a href="instrument/create"
                                    class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded inline-block">Nou
                                    instrument</a>
                            </div>
                            <table class="min-w-full divide-y divide-gray-200 w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($intruments as $intrument)
                                        <tr>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900 text-center">
                                                {{ $intrument->name }}
                                            </td>
