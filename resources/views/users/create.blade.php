            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <form method="post" action="{{ isset($user) ? route('users.update', $user->id) : route('users.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="porcentaje" class="block font-medium text-sm text-gray-700">Porcentaje</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="forastero" class="block font-medium text-sm text-gray-700">Forastero</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="activo" class="block font-medium text-sm text-gray-700">Activo</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="fechaAlta" class="block font-medium text-sm text-gray-700">Fecha Alta</label>
