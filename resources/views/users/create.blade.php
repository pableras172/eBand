            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <form method="post" action="{{ isset($user) ? route('users.update', $user->id) : route('users.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="instrument" class="block font-medium text-sm text-gray-700">{{__('Instrument')}}</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="telefono" class="block font-medium text-sm text-gray-700">{{__('Telefon')}}</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="porcentaje" class="block font-medium text-sm text-gray-700">{{__('Percentaje')}}</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="forastero" class="block font-medium text-sm text-gray-700">{{__('Foraster')}}</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="activo" class="block font-medium text-sm text-gray-700">{{__('Actiu')}}</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="fechaAlta" class="block font-medium text-sm text-gray-700">{{__('Data Alta')}}</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <label for="observaciones" class="block font-medium text-sm text-gray-700">{{__('Observacions')}}</label>
