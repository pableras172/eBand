<div class="bg-gray-100 min-h-screen flex flex-col items-center">
    <div class="w-full max-w-2xl bg-white p-2 rounded-lg shadow-md text-center mt-1">
        ...
        <div class="relative w-20 h-20 mx-auto mb-3">
            ...
            <div class="absolute bottom-0 right-0 w-6 h-6 bg-white rounded-full border-2 border-blue-500 flex items-center justify-center">
                <img src="{{ asset('storage/imagenes/instruments/' . Auth::user()->instrument->icon) }}" 
                     alt="{{ Auth::user()->instrument }}" 
                     class="w-4 h-4">
            </div>
        </div>
